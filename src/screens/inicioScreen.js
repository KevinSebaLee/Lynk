...
const styles = StyleSheet.create({
  ...
  botonLight:{ backgroundColor: '#fff', width:120, height:40, borderColor: '#642684', borderRadius:5, textAlign:'center', paddingTop:9, shadowColor: "#000", shadowOffset: {width: 0, height: 9}, shadowOpacity: 0.50, shadowRadius: 12.35, elevation: 19 },
});